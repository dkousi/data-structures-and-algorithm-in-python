...
class Box:
    ...
    def display_ball_details(self,manufacturer):
        if  manufacturer == "Penn":
            index=self.manufacturer1_stack.get_max_size()
            while(index>=0):
                print(self.manufacturer1_stack[index])
                index-=1
        else:
            index=self.manufacturer2_stack.get_max_size()
            while(index>=0):
                print(self.manufacturer2_stack[index])
                index-=1
